...
const styles = StyleSheet.create({screen:{flex:1,backgroundColor:colors.bg},content:{padding:sw(20),paddingTop:sw(52),gap:sw(12)},header:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},reverse:{flexDirection:'row-reverse'},kicker:{color:colors.gold,fontWeight:'900',letterSpacing:2},title:{fontSize:sw(26),fontWeight:'900',color:colors.navy},langButton:{borderRadius:18,backgroundColor:colors.navy,paddingVertical:10,paddingHorizontal:13},langText:{color:colors.white,fontWeight:'900',fontSize:sw(13)},sourceCard:{backgroundColor:'#E7F7EF',borderRadius:20,padding:12},sourceText:{color:colors.teal,fontWeight:'900'},quickRow:{flexDirection:'row',gap:10},stat:{flex:1,backgroundColor:colors.white,borderRadius:20,padding:sw(12)},statValue:{color:colors.gold,fontSize:sw(22),fontWeight:'900'},statLabel:{color:colors.muted,fontWeight:'800',fontSize:sw(12)},refresh:{backgroundColor:colors.navy,borderRadius:18,padding:sw(12),alignItems:'center'},refreshText:{color:colors.white,fontWeight:'900'},card:{backgroundColor:colors.white,borderRadius:28,padding:sw(16),gap:6},route:{color:colors.text,fontSize:sw(17),fontWeight:'900',flexShrink:1},meta:{color:colors.muted,marginTop:4,fontSize:sw(13)},details:{alignSelf:'flex-start',backgroundColor:colors.gold,borderRadius:14,paddingVertical:9,paddingHorizontal:12,marginTop:8},detailsText:{color:colors.navy,fontWeight:'900',fontSize:sw(13)},rtl:{textAlign:'right',writingDirection:'rtl'}});
